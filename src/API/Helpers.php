...
class Helpers
{
     ...
     * @param string|array $fields Control what fields are being returned into the object.
     * @return string
     */
     ...
     *   type         - If it's a collection or an item
     ...
     * @param string|array $meta What metadata to return to the response.
     * @return string
     */
     ...
     * @return array
     */
    public static function filter(array $filter): array
    {
        return $filter;
    }
